<div class="container">
  ...
  <div class="mb-3">
    ...
    <input value="<?= $siswa['tanggal_lahir']?>" type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" require>
  </div>
  <div class="mb-3">
    <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
    <input value="<?= $siswa['tempat_lahir']?>" type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" require>
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <select  class="form-control form-control-user" aria-label=".form-select-lg example" name="jenis_kelamin" require>
